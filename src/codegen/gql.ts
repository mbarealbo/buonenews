 ...
 */
const documents = {
    "query EvaluatedArticle($sentiment: String) {\n  evaluatedArticle(filter: {aiSentiment: {eq: $sentiment}}) {\n    ...EvaluatedArticle\n  }\n}\n\nfragment EvaluatedArticle on EvaluatedArticleRecord {\n  id\n  title\n  description\n  link\n  publishedDatetime\n  formattedDatetime\n  publication {\n    ...Publication\n  }\n  aiSentiment\n  aiComment\n}\n\nfragment ArticleListBlock on ArticleListBlockRecord {\n  id\n}": types.EvaluatedArticleDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query EvaluatedArticle($sentiment: String) {\n  evaluatedArticle(filter: {aiSentiment: {eq: $sentiment}}) {\n    ...EvaluatedArticle\n  }\n}\n\nfragment EvaluatedArticle on EvaluatedArticleRecord {\n  id\n  title\n  description\n  link\n  publishedDatetime\n  formattedDatetime\n  publication {\n    ...Publication\n  }\n  aiSentiment\n  aiComment\n}\n\nfragment ArticleListBlock on ArticleListBlockRecord {\n  id\n}"): (typeof documents)["query EvaluatedArticle($sentiment: String) {\n  evaluatedArticle(filter: {aiSentiment: {eq: $sentiment}}) {\n    ...EvaluatedArticle\n  }\n}\n\nfragment EvaluatedArticle on EvaluatedArticleRecord {\n  id\n  title\n  description\n  link\n  publishedDatetime\n  formattedDatetime\n  publication {\n    ...Publication\n  }\n  aiSentiment\n  aiComment\n}\n\nfragment ArticleListBlock on ArticleListBlockRecord {\n  id\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
