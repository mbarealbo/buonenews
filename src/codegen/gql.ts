 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "fragment ArticleListBlock on ArticleListBlockRecord {\n  id\n}"): (typeof documents)["fragment ArticleListBlock on ArticleListBlockRecord {\n  id\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
