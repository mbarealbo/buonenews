...
/** Block of type ♨️ RSS Item (rss_item) */
export type RssItemRecord = RecordInterface & {
  __typename?: 'RssItemRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt?: Maybe<Scalars['DateTime']['output']>;
...
/** Block of type ♨️ RSS Item (rss_item) */
export type RssItemRecord_SeoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
export type PublicationQuery = { __typename?: 'Query', allPublications: Array<{ __typename?: 'PublicationRecord', organization: string, rssLink: string, enabled: boolean }> };
...
export type PageQuery = { __typename?: 'Query', page?: { __typename?: 'PageRecord', id: string, slug: string, title: string } | null };
