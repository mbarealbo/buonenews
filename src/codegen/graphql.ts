...
export type AllEvaluatedArticlesQuery = { __typename?: 'Query', allEvaluatedArticles: Array<{ __typename?: 'EvaluatedArticleRecord', id: string, title: string, description: string, link: string, publishedDatetime: number, formattedDatetime: string, aiSentiment: string, aiComment: string, publication: { __typename?: 'PublicationRecord', id: string, organization: string } }> };

export type EvaluatedArticleFragment = { __typename?: 'EvaluatedArticleRecord', id: string, title: string, description: string, link: string, publishedDatetime: number, formattedDatetime: string, aiSentiment: string, aiComment: string, publication: { __typename?: 'PublicationRecord', id: string, organization: string } };
